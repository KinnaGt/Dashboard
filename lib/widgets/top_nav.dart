...
AppBar topNavigationBar(BuildContext context,GlobalKey<ScaffoldState> key) =>  // The key is used when we call the drawer or the side menu
  AppBar(
    ...
    title: Row(
      children: [
        ...
        IconButton(icon: Icon(Icons.settings,color: dark.withOpacity(.7)),
            onPressed: (){
        ...
        CustomText(text: "Iñaki Lapeyre", color: dark, weight: FontWeight.normal, size: 0,),
